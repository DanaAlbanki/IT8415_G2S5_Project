<?php
// This code is used enable PHP error reporting for development
error_reporting(E_ALL);
ini_set('display_errors', 1);

// This code is used to start the session only if it has not already started
...
// This code is used to fetch movie details from TMDB API
